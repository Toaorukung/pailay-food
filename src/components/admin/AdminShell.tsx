...
const NAV_GROUPS: { label: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { href: '/admin/sessions', label: 'เซสชัน', icon: Users, permission: 'sessions' },
    ],
  },
  {
    label: 'จัดการร้าน',
    items: [
      ...
      { href: '/admin/guest-fields', label: 'คำถามตอนเริ่มสั่ง', icon: FormInput, permission: 'guest_fields' },
      { href: '/admin/tables', label: 'วิลล่า', icon: Home, permission: 'tables' },
      { href: '/admin/reports', label: 'รายงาน', icon: BarChart3, permission: 'reports' },
    ],
  },
  {
    label: 'เจ้าของร้าน',
