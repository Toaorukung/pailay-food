...
const settings: PublicSettings = {
  ...
  serviceNotice: loc(
    [
      'ครัวเปิด 10:00-20:00 น. · รับออเดอร์ถึง 21:00 น.',
      ...
      'อาหารเช้า สั่งล่วงหน้าไม่เกิน 17:00 น. ของวันก่อน ขั้นต่ำ 16 ท่าน ส่งถึงไม่เกิน 08:30 น. · เก็บยอดก่อนเพื่อยืนยันออเดอร์',
    ...
    [
      'Kitchen open 10:00-20:00; orders accepted until 21:00.',
      ...
      'Breakfast must be ordered by 17:00 the day before, minimum 16 guests, delivered by 08:30, paid upfront to confirm.',
    ...
    [
      '厨房营业 10:00-20:00，接单至 21:00。',
      '每次配送最低消费 500 泰铢（不含早餐套餐、烤乳猪与饮料）。',
      '配送约需 1 小时，视厨房排队与路程而定。',
      '早餐需于前一天 17:00 前预订，最少 16 位，08:30 前送达，需先付款确认。',
