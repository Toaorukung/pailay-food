...
export const ITEMS: SeedItem[] = [
  ...
  // ── ปู ───────────────────────────────────────────────────
  {
    ...
    th: 'ปูนึ่ง', en: 'Steamed crab', zh: '清蒸螃蟹',
    ...
    ingTh: 'ปูสด, น้ำจิ้มซีฟู้ด', ingEn: 'fresh crab, seafood dipping sauce', ingZh: '鲜蟹、海鲜蘸酱',
    price: 0, onRequest: true,
    allergens: [CRUST], may: [MOLL, FISH],
    tags: ['ปู', 'นึ่ง', 'ถามราคา', 'crab', 'market price'],
  },
  {
  ...
  },
  {
    ...
    descTh: 'จานละ 5 ตัว หรือสั่งเป็นกิโล · ชั่งน้ำหนักก่อนปรุง',
    descEn: 'Five per plate, or by the kilo. Sold by weight.',
    price: 0, onRequest: true,
  ...
  // ── หมูหัน ───────────────────────────────────────────────
  {
    ...
    descTh: 'หนังกรอบ หอมอร่อย เนื้อนุ่ม ไม่มัน · ย่างเตาถ่าน หมักเครื่องเทศสูตรพิเศษ · กรุณาสั่งล่วงหน้า',
    descEn: 'Crisp skin, tender meat, charcoal-roasted with a house spice marinade. Please order in advance.',
    descZh: '皮脆肉嫩，炭火烤制，特调香料腌制。请提前预订。',
    ingTh: 'หมูหันทั้งตัว, เครื่องเทศหมัก, น้ำจิ้ม',
    ingEn: 'whole suckling pig, spice marinade, dipping sauce', ingZh: '整只乳猪、香料腌料、蘸酱',
    price: 2500, allergens: [PORK, SOY], may: [GLUTEN, SESAME],
    tags: ['หมูหัน', 'ปาร์ตี้', 'สั่งล่วงหน้า', 'roast pig', 'party'],
    groups: [pick('g-roastpig-size', 'ขนาด', 'Size', '份量', [
  ...
  // ── อาหารเช้า ────────────────────────────────────────────
  {
    ...
    descTh: 'สั่งล่วงหน้าไม่เกิน 17:00 น. ของวันก่อนจัดส่ง · ขั้นต่ำ 10 ท่าน · ส่งถึงไม่เกิน 08:30 น.',
    descEn: 'Order by 17:00 the day before. Minimum 10 guests. Delivered by 08:30.',
    descZh: '需于前一天 17:00 前预订，最少 10 位，08:30 前送达。',
  ...
  },
  {
    ...
    descTh: 'ไส้กรอก + ไข่ดาว + แฮม + กาแฟ + โอวัลติน · ราคาต่อ 1 ชุด',
    descEn: 'Sausage, fried egg, ham, coffee and Ovaltine. Price per set.',
    descZh: '香肠、煎蛋、火腿、咖啡与阿华田。每套价格。',
    ...
    price: 259, allergens: [PORK, EGG, DAIRY, GLUTEN, SOY],
    tags: ['อาหารเช้า', 'ABF', 'breakfast', 'set'],
  },

  // ── เครื่องดื่ม ──────────────────────────────────────────
  { id: 'm-water-pack', cat: 'c-drink', order: 10, th: 'น้ำเปล่า (แพ็ค 12 ขวด)', en: 'Drinking water, pack of 12', zh: '瓶装水（12 瓶装）',
    ingTh: 'น้ำดื่ม', ingEn: 'drinking water', ingZh: '饮用水',
    price: 65, veg: true, tags: ['น้ำ', 'water'] },
  { id: 'm-coke', cat: 'c-drink', order: 20, th: 'โค้ก 1.5 ลิตร', en: 'Coca-Cola 1.5L', zh: '可口可乐 1.5 升',
  ...
  { id: 'm-pepsi', cat: 'c-drink', order: 30, th: 'เป๊ปซี่ 1.5 ลิตร', en: 'Pepsi 1.5L', zh: '百事可乐 1.5 升',
  ...
  { id: 'm-soda', cat: 'c-drink', order: 40, th: 'โซดา', en: 'Soda water', zh: '苏打水',
  ...
  // ── เบียร์ & เหล้า ───────────────────────────────────────
  { id: 'm-beer-singha', cat: 'c-beer', order: 10, th: 'เบียร์สิงห์', en: 'Singha beer', zh: '胜狮啤酒',
  ...
  { id: 'm-beer-leo', cat: 'c-beer', order: 20, th: 'เบียร์ลีโอ', en: 'Leo beer', zh: 'Leo 啤酒',
    descTh: 'จำหน่ายเฉพาะผู้มีอายุ 20 ปีขึ้นไป', descEn: 'Sold to persons aged 20 and over only',
    ingTh: 'เบียร์ (มอลต์, ข้าวบาร์เลย์)', ingEn: 'beer (malt, barley)', ingZh: '啤酒（麦芽、大麦）',
  ...
  { id: 'm-beer-chang', cat: 'c-beer', order: 30, th: 'เบียร์ช้าง', en: 'Chang beer', zh: '象牌啤酒',
    descTh: 'จำหน่ายเฉพาะผู้มีอายุ 20 ปีขึ้นไป', descEn: 'Sold to persons aged 20 and over only',
    ingTh: 'เบียร์ (มอลต์, ข้าวบาร์เลย์)', ingEn: 'beer (malt, barley)', ingZh: '啤酒（麦芽、大麦）',
  ...
  { id: 'm-spy', cat: 'c-beer', order: 40, th: 'SPY Red / Purple', en: 'SPY wine cooler', zh: 'SPY 气泡酒',
    descTh: 'จำหน่ายเฉพาะผู้มีอายุ 20 ปีขึ้นไป', descEn: 'Sold to persons aged 20 and over only',
  ...
  { id: 'm-regency', cat: 'c-beer', order: 50, th: 'รีเจนซี่ (แบน)', en: 'Regency brandy, flat bottle', zh: 'Regency 白兰地（扁瓶）',
    descTh: 'จำหน่ายเฉพาะผู้มีอายุ 20 ปีขึ้นไป', descEn: 'Sold to persons aged 20 and over only',
    price: 420, alcohol: true, allergens: [BOOZE], tags: ['เหล้า', 'แอลกอฮอล์', 'spirits'] },

  // ── น้ำแข็ง & ถ่าน ───────────────────────────────────────
  { id: 'm-ice', cat: 'c-supply', order: 10, th: 'น้ำแข็ง (กระสอบ)', en: 'Ice, per sack', zh: '冰块（一袋）',
    descTh: 'กรุณาสั่งก่อน 17:00 น.', descEn: 'Please order before 17:00', descZh: '请于 17:00 前订购',
    price: 100, veg: true, tags: ['น้ำแข็ง', 'ice'] },
  { id: 'm-charcoal', cat: 'c-supply', order: 20, th: 'ถ่านปิ้งย่าง (ถุง)', en: 'Barbecue charcoal, per bag', zh: '烧烤木炭（一袋）',
    descTh: 'กรุณาสั่งก่อน 17:00 น.', descEn: 'Please order before 17:00', descZh: '请于 17:00 前订购',
